...
namespace LogicMonitor.Api
{
	...
	public partial class PortalClient
	{
		...
		/// <returns></returns>
		[Obsolete("Use GetAllAsync<LogItem>() instead.", true)]
		public Task<List<LogItem>> GetLogItemsAsync(LogFilter logFilter = null, CancellationToken cancellationToken = default)
